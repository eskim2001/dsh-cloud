...
```bash
curl -fsSL https://raw.githubusercontent.com/eskim2001/dsh-cloud/v0.1.5/scripts/install.sh | sudo bash
```
...
```bash
curl -fsSL "https://raw.githubusercontent.com/eskim2001/dsh-cloud/v0.1.5/scripts/install.sh" | sha256sum
```

```bash
git show v0.1.5:scripts/install.sh | sha256sum
```
...
```bash
curl -fsSL "https://raw.githubusercontent.com/eskim2001/dsh-cloud/v0.1.5/scripts/install.sh" | sudo bash -s -- uninstall
```
